...
export const metadata: Metadata = {
  title: "Ralph Lauren - Luxury Fashion & Clothing",
  description: "Discover Ralph Lauren's iconic collections of luxury fashion, from classic polo shirts to sophisticated evening wear. Premium quality and timeless American style.",
  keywords: "Ralph Lauren, luxury fashion, designer clothing, premium brands, polo shirts, luxury apparel",
  openGraph: {
    title: "Ralph Lauren - Luxury Fashion & Clothing",
    description: "Discover iconic Ralph Lauren collections featuring luxury fashion, classic polos, and sophisticated designs.",
    type: "website",
    siteName: "Ralph Lauren"
  },
  twitter: {
    card: "summary_large_image",
    title: "Ralph Lauren - Timeless Luxury Fashion",
    description: "Premium clothing and accessories from Ralph Lauren"
  }
};
